...
const getImageEdgePoints = async (directory, imageName, extension) => {
 const imageOpacityMatrix = await getImageOpacityMatrix(directory, imageName, extension);
 const imageTransparencyMatrix = getImageTransparencyMatrix(imageOpacityMatrix);
 ...
 const mergedPointsWithoutDuplicates = getMergedPointsWithoutDuplicates([...rigthEdgePoints, ...leftEdgePoints, ...topEdgePoints, ...bottomEdgePoints]);
 return mergedPointsWithoutDuplicates;
};
